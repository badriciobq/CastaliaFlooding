...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /home/administrador/Castalia-3.2 -M release -X Simulations -X out -X bin
#
...
INCLUDE_PATH = \
    ...
    -Isrc/node/application/floodApplication \
...
OBJS = \
    ...
    $O/src/node/application/floodApplication/FloodApplication.o \
    ...
    $O/src/node/application/floodApplication/FloodPacket_m.o \
...
MSGFILES = \
    ...
    src/node/application/floodApplication/FloodPacket.msg \
...
clean:
	...
	-rm -f src/node/application/floodApplication/*_m.cc src/node/application/floodApplication/*_m.h
...
$O/src/node/application/connectivityMap/ConnectivityMap.o: src/node/application/connectivityMap/ConnectivityMap.cc \
  ...
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/application/ApplicationPacket_m.h
$O/src/node/application/floodApplication/FloodApplication.o: src/node/application/floodApplication/FloodApplication.cc \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  ...
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/VirtualApplication.h \
  src/node/application/floodApplication/FloodApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/communication/radio/Radio.h \
  ...
  src/helpStructures/TimerService.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/floodApplication/FloodPacket_m.h
